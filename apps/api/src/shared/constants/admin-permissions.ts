...
export const AdminPermissions = {
  ...
  // Stage 16: Advanced Team Management
...
export const RolePermissions = {
  ...
  ADMIN: [
    ...
    AdminPermissions.TEAM_ANALYTICS_VIEW,
    AdminPermissions.CUSTOM_ROLES_VIEW,
    AdminPermissions.CUSTOM_ROLES_MANAGE,
    AdminPermissions.TEAM_MEMBERS_BULK,
    AdminPermissions.COMMUNICATIONS_VIEW,
    AdminPermissions.COMMUNICATIONS_MANAGE,
    AdminPermissions.COMMUNICATIONS_BROADCAST,
    AdminPermissions.TEAM_OPERATIONS_MERGE,
    AdminPermissions.TEAM_OPERATIONS_CLONE,
    AdminPermissions.TEAM_TEMPLATES_VIEW,
    AdminPermissions.TEAM_TEMPLATES_MANAGE,
    AdminPermissions.TEAM_AUDIT_VIEW,
    AdminPermissions.COMPLIANCE_VIEW,
    AdminPermissions.DATA_RETENTION_MANAGE,
    AdminPermissions.DATA_EXPORT_REQUEST,
