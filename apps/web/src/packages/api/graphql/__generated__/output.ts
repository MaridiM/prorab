...
export type MySubscriptionHistoryFromPaymentsQuery = { __typename?: 'Query', mySubscriptionHistoryFromPayments: Array<{ __typename?: 'SubscriptionHistoryModel', id: string, planName: string, planSlug: string, amount: number, currency: string, isEarlyBird: boolean, paidAt: string, createdAt: string }> };
